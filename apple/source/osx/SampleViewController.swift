...
class SampleViewController : NSViewController {
    ...
    override func loadView() {
        ...
        // sizing constraints
        // subview
        let subview_horizontal_size_constraint: Array = NSLayoutConstraint.constraints(withVisualFormat: "H:[subview(subview_width)]", options: NSLayoutFormatOptions(rawValue: 0), metrics: metric_dictionary as [String : NSNumber]?, views: view_dictionary);
        let subview_vertical_size_constraint: Array = NSLayoutConstraint.constraints(withVisualFormat: "V:[subview(subview_height)]", options: NSLayoutFormatOptions(rawValue: 0), metrics: metric_dictionary as [String : NSNumber]?, views: view_dictionary);
